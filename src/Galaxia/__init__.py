...
def make_survey_from_particles(*args, particles, rho_pos, rho_vel, pname=None, kname=None, photo_sys=DEFAULT_PSYS, cmd_magnames=DEFAULT_CMD, simname='sim', surveyname='survey', fsample=1, ngb=64, knorm=0.596831, **kwargs):
    """
