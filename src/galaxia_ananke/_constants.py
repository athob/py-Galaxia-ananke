...
__all__ = ['NAME', 'GALAXIA_SUBMODULE_NAME', 'GALAXIA_URL', 'GALAXIA_EXEC', 'SRC_DIR', 'LOG_DIR', 'NBODY1', 'LEGACY_PHOTOCAT', 'CUSTOM_PHOTOCAT', 'HASH_EXT', 'HASH_ENCODING', 'GALAXIA_DATA', 'GALAXIA_NBODY1', 'GALAXIA_FILENAMES', 'GALAXIA_LOG', 'GALAXIA', 'ISOCHRONES_PATH', 'CACHE', 'METADATA_HEADER_KEY', 'PARAMETER_METADATA_PREFIX', 'INPUT_METADATA_PREFIX', 'SURVEY_METADATA_PREFIX']
...
METADATA_HEADER_KEY = 'Header'
PARAMETER_METADATA_PREFIX = 'SurveyParam_'
INPUT_METADATA_PREFIX = 'Input_'
SURVEY_METADATA_PREFIX = 'Survey_'
